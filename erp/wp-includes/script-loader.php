...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'scriptaculous-root', '/wp-includes/js/googleapis/scriptaculous.js', array( 'prototype' ), '1.9.0' );
	$scripts->add( 'scriptaculous-builder', '/wp-includes/js/googleapis/builder.js', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-dragdrop', '/wp-includes/js/googleapis/dragdrop.js', array( 'scriptaculous-builder', 'scriptaculous-effects' ), '1.9.0' );
	$scripts->add( 'scriptaculous-effects', '/wp-includes/js/googleapis/effects.js', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-slider', '/wp-includes/js/googleapis/slider.js', array( 'scriptaculous-effects' ), '1.9.0' );
	$scripts->add( 'scriptaculous-sound', '/wp-includes/js/googleapis/sound.js', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-controls', '/wp-includes/js/googleapis/controls.js', array( 'scriptaculous-root' ), '1.9.0' );
